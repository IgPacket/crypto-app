...
1) Взаимодействовать с балансами и адресами следующих валют: bitcoin, ethereum, stellar, ripple, tron 
2) Добавлять адреса валют через private key 
3) Добавлять адреса валют через Seed-phrase 
4) Редактировать список валют
5) Просматривать баланс валют
6) Автоматически конвертировать баланс валюты в доллары учитывая актуальный курс
